...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path d="m14.75 12.17-3.73 3.73c-.07.07-.17.07-.24 0l-1.53-1.53a.803.803 0 0 0-1.13 0c-.31.31-.31.82 0 1.13l2.22 2.22c.31.31.82.31 1.13 0l4.41-4.41c.31-.31.31-.82 0-1.13a.803.803 0 0 0-1.13 0Z" />
    </g>
  </svg>
)

export const CalendarCheckAltOutlineIcon = createIcon(
  "CalendarCheckAltOutlineIcon",
  SVGComponent,
  {
