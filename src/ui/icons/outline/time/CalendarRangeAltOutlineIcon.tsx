...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path d="M10.95 13.82h6.27a.781.781 0 0 0 0-1.56h-6.27a.781.781 0 0 0 0 1.56m2.09 2.61H6.77a.781.781 0 0 0 0 1.56h6.27a.781.781 0 0 0 0-1.56m-6.26-2.61a.781.781 0 0 0 0-1.56h-.01c-.43 0-.78.35-.78.78s.36.78.79.78m10.45 2.61h-.01c-.43 0-.78.35-.78.78s.36.78.79.78a.781.781 0 0 0 0-1.56" />
    </g>
  </svg>
)

export const CalendarRangeAltOutlineIcon = createIcon(
  "CalendarRangeAltOutlineIcon",
  SVGComponent,
  {
