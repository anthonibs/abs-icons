...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path d="M7.36 11.25c-.57 0-1.06.2-1.46.6s-.6.89-.6 1.46.2 1.06.6 1.46.89.6 1.46.6 1.06-.2 1.46-.6.6-.89.6-1.46-.2-1.06-.6-1.46-.89-.6-1.46-.6" />
    </g>
  </svg>
)

export const CalendarTodayAltOutlineIcon = createIcon(
  "CalendarTodayAltOutlineIcon",
  SVGComponent,
  {
