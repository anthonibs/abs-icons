...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path d="M14.44 11.6c.27-.27.27-.7 0-.98s-.7-.27-.98 0L12.08 12s-.12.05-.17 0l-1.38-1.38c-.27-.27-.7-.27-.98 0s-.27.7 0 .98l1.38 1.38s.05.12 0 .17l-1.38 1.38a.694.694 0 0 0 .98.98l1.38-1.38s.12-.05.17 0l1.38 1.38a.694.694 0 0 0 .98-.98l-1.38-1.38s-.05-.12 0-.17z" />
    </g>
  </svg>
)

export const AlarmClockRemoveAltOutlineIcon = createIcon(
  "AlarmClockRemoveAltOutlineIcon",
  SVGComponent,
  {
