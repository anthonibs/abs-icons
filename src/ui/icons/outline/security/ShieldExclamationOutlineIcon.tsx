...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="M12 13.12c-.41 0-.75-.34-.75-.75V8.62c0-.41.34-.75.75-.75s.75.34.75.75v3.75c0 .41-.34.75-.75.75m0 3.01c-.41 0-.76-.34-.76-.75s.34-.76.75-.76.75.34.75.75-.34.76-.75.76Z" />
  </svg>
)

export const ShieldExclamationOutlineIcon = createIcon(
  "ShieldExclamationOutlineIcon",
  SVGComponent,
  {
