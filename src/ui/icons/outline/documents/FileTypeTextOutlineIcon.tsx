...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M16 15.2H8c-.44 0-.8.36-.8.8s.36.8.8.8h8c.44 0 .8-.36.8-.8s-.36-.8-.8-.8m-8.07-2.4H13c.44 0 .8-.36.8-.8s-.36-.8-.8-.8H7.93c-.44 0-.8.36-.8.8s.36.8.8.8" />
...
export const FileTypeTextOutlineIcon = createIcon(
  "FileTypeTextOutlineIcon",
  SVGComponent,
  {
