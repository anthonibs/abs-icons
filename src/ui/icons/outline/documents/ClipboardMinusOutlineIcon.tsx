...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g>
      ...
      <path d="M14.93 14.23H9.08c-.4 0-.73-.33-.73-.73s.33-.73.73-.73h5.85c.4 0 .73.33.73.73s-.33.73-.73.73" />
    </g>
  </svg>
)

export const ClipboardMinusOutlineIcon = createIcon(
  "ClipboardMinusOutlineIcon",
  SVGComponent,
  {
