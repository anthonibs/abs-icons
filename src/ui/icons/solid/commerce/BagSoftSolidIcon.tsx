...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      d="M3.56 14.63c-.18-.84-.34-1.57-.46-2.22-.03-.15.09-.29.25-.29h17.3c.16 0 .28.14.25.29-.12.65-.28 1.38-.46 2.22l-.42 2c-.49 2.27-.73 3.41-1.56 4.08-.82.67-1.99.67-4.31.67h-4.3c-2.32 0-3.49 0-4.31-.67-.83-.67-1.07-1.8-1.56-4.08zM10 13.62c-.41 0-.75.34-.75.75s.34.75.75.75h4c.41 0 .75-.34.75-.75s-.34-.75-.75-.75z"
    />
  </svg>
)
