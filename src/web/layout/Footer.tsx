  ...
  return (
    <footer className="border-t border-abs-card-border bg-abs-background-dark pt-16 pb-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          <div className="md:col-span-4 flex flex-col gap-4">
            <div className="flex items-center space-x-3 opacity-60 grayscale">
              ...
              />
              <span className="font-bold text-3xl tracking-tight text-abs-text-main">
                Abs Icons
              </span>
            </div>
            <p className="text-sm text-abs-text-muted max-w-xs leading-relaxed">
              A high-performance icon library optimized for React and modern
              developer workflows. Simple, lightweight, and scalable.
            </p>
            <div className="mt-2 flex items-center gap-2 text-[11px] text-abs-text-muted font-medium">
              <span>Built with</span>
              <div className="flex items-center gap-1.5 px-2 py-0.5 bg-abs-card-dark border border-abs-card-border-dark rounded-md text-abs-text-main">
                <svg
                  viewBox="0 0 569 512"
        ...
        <div className="pt-8 border-t border-abs-card-border/50 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-abs-text-muted">
            © 2026 Abs Icons. All rights reserved. Built with precision for the
            modern web.
          </p>
